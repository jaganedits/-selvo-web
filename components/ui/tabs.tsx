...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-xl p-1 text-muted-foreground group-data-horizontal/tabs:h-9 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted/60 border border-border/50",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:bg-card data-active:text-foreground data-active:shadow-sm data-active:border-border/60 dark:data-active:bg-input/30 dark:data-active:border-input dark:data-active:text-foreground group-data-[variant=line]/tabs-list:data-active:shadow-none",
